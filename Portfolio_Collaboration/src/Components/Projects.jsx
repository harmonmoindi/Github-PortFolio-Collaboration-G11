...
const teamProjects = [
  {
    ...
    avatarImg:
      "https://static.vecteezy.com/system/resources/thumbnails/074/527/716/small/minimalist-silhouette-human-user-profile-avatar-placeholder-shape-icon-vector.jpg",
    projects: [
      {
        title: "Automobile Company",
        description: "Sells different types of cars.",
        image: "/project 1 Barbara.png",
      },
      {
        title: "SokoPlus",
        description: "A shopping platform from trusted independent sellers.",
  ...
  },
  {
    ...
    projects: [
      {
        title: "CV Center",
        description: "A place you can make & download your CV (CV Center).",
        image: "/Project 1 Harmon.jpg",
      },
      {
        title: "Trading Performance Tracker",
        description:
          "A web application used to help you keep track and improve your trading.",
  ...
  },
  {
    ...
    projects: [
      {
        title: "Akan Generator",
        description: "A Ghanian naming system by gender & days of the week.",
        image: "/project 1 Frank.jpeg",
      },
      {
        title: "Mediflow",
        description: "A hospital medical traffic system.",
